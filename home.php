  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
      ...
      <div class="jumbotron " style="margin-top:0px; margin-bottom:0px;background-color:#ffe2e6">
        ...
        <p class="lead">As of now, the app allows you to add the vendor's general details such as the name, address, description.
          In the future, we aim to extend the functionality in the following ways- <br><br>
            Allowing users to review the vendors <br>
            Allow users to add images<br>
            Allow users to mark the vendor volatile/involatile<br>
        </p>
      </div>
